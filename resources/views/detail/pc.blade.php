                      ...
                      <div class="panel panel-info">
                        <div class="panel-body">
                         <div class="chinhsach">
                            ...
                            <li><span class="glyphicon glyphicon-hand-right"></span> Gồm Tag,Sản Phẩm,Tem chính hãng</li>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="table-responsive">
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          <th colspan="2">THÔNG TIN SẢN PHẨM: <strong>{!!$slug!!}</strong> </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
    ...
    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding">            
      ...
      <div class="panel panel-info">
        <div class="panel-heading">
          <h3 class="panel-title text-center">Xem thêm</h3>
        </div>
            ...
            <div class="thumbnail mobile">              
              ...
              <div class="ct">
                <a href="{!!url('mobile/'.$row->id.'-'.$row->slug)!!}" title="Chi tiết">
                  ...
                  <li><strong>Sản xuất</strong> :  <i>{!!$row->cam1!!}</i> Kích thước <i>{!!$row->cam2!!}</i></li> 
