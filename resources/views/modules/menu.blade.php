 <!-- main menu  navbar -->
    <nav class="navbar navbar-default navbar-top" role="navigation" id="main-Nav" style="background-color: #110000	;margin-bottom: 5px;font-size: 13px;">
      <div class="container">  
        <div class="row">
          ...
          <div class="collapse navbar-collapse" id="main-mav-top">
            <ul class="nav navbar-nav">
              ...
              <li>
                <a href="{!!url('mobile')!!}" >Sneaker </a>                          
              </li>                                                  
              <li >
                <a href="{!!url('laptop')!!}" >  Pants </a>                
              </li>    
              <li>
                <a href="{!!url('pc')!!}" > Tee </a>                
              </li>                                          
