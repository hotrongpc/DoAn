    ...
    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 no-padding"> 
        <div class="fluid_container" style="height: 250px;">            
          <div class="camera_violet_skin" id="camera_wrap_1">
            <div class="img-responsive" data-thumb="public/images/slides/thumbs/qc1.jpg" data-src="public/images/slides/qc1.jpg">
                <div class="camera_caption fadeFromBottom">
                Dior hân hạnh hợp tác! <em>Sản phẩm chất lượng</em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="public/images/slides/thumbs/qc2.jpg" data-src="public/images/slides/qc2.jpg">
                <div class="camera_caption fadeFromBottom">
                Louis Vuitton<em> Luôn cung cấp cho các bạn những mặt hàng hot </em>          
                </div>
            </div>
            <div class="img-responsive" data-thumb="public/images/slides/thumbs/qc3.jpg" data-src="public/images/slides/qc3.jpg">
                <div class="camera_caption fadeFromBottom">
                Gucci <em> Một biểu tượng thời trang sở hữu bởi Ý   </em>         
                </div>
            </div>
